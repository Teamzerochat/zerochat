...
# Set Android NDK path (Update this if you use diverse NDK versions)
$env:ANDROID_NDK_HOME = "C:\Users\harsh\AppData\Local\Android\Sdk\ndk\26.1.10909125"
...
cargo run --bin uniffi-bindgen generate src/nym_transport.udl --language kotlin --out-dir ../app/src/main/java
